...
2. Installing the satTest Package

A. Change to the directory that contains the file setup.py and the subdirectory satTest. 
...
3. Using the satTest Package

The satTest package is on your Python path. To import it into a Python script or session, 
execute:
